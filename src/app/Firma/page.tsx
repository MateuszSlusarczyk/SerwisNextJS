      ...
      <div className="w-full h-1/2">
        <div className="mb-4 md:flex md:justify-between">
          ...
          <Image
                    ...
                    />
            <p className="ml-2 text-lg">Dodaj Firmę</p>
            </button>
          ...
          <Image
                    ...
                    className='inline-block'
                    />
            <p className="ml-2 text-lg">Aktualizuj Firmę</p>
          ...
          <Image
                    ...
                    className='inline-block'
                    />
            <p className="ml-2 text-lg">Usuń Firmę</p></button>
        </div>
        <div className="flex flex-row flex-wrap w-full justify-between">
          <div className="w-full md:w-1/3">
            {showRegisterForm && <FirmaAdd />}
          </div>
          <div className="w-full md:w-1/3">
            {showUpdateComponent && <FirmaUpdate />}
          </div>
          <div className="w-full md:w-1/3">
            {showDeleteComponent && <FirmaDelete />}
          </div>
        </div>
        <GetFirma />
      </div>
