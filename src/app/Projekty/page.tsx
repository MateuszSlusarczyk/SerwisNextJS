      ...
      <div className="w-full h-1/2">
        <div className="mb-4 md:flex md:justify-between">
          ...
          <Image
                    ...
                    />
            <p className="ml-2 text-lg">Dodaj Projekt</p>
            </button>
          ...
          <Image
                    ...
                    className='inline-block'
                    />
            <p className="ml-2 text-lg">Aktualizuj Projekt</p>
          ...
          <Image
                    ...
                    className='inline-block'
                    />
            <p className="ml-2 text-lg">Usuń Projekt</p></button>
        </div>
        <div className="flex flex-row flex-wrap w-full justify-between">
          <div className="w-full md:w-1/3">
            {showRegisterForm && <ProjektyAdd />}
          </div>
          <div className="w-full md:w-1/3">
            {showUpdateComponent && <ProjektyUpdate />}
          </div>
          <div className="w-full md:w-1/3">
            {showDeleteComponent && <ProjektyDelete />}
          </div>
        </div>
        <GetProjekty />
      </div>
